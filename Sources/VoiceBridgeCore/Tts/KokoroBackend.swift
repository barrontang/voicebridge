...
public struct KokoroBackend: TTSBackend {
   ...
   public let producesAudioFile = true
         ...
         /// Directory generated audio is written to (Finding 2: injected instead of
        /// the static `ModelPaths.cacheDir`).
   ...
   private let binaryPath: String
    ...
    public init(voice: String? = nil,
                  cacheDirectory: URL = ModelPaths.fromEnvironment().cacheDir,
        ...
        if let raw {
             ...
             self.binaryPath = binaryLocator.resolve(preferred: "VOICEBRIDGE_KOKORO", "kokoro")
              }
